                                ...
                                <div className="block space-y-3">
                                  ...
                                  {message.img &&
                                    animationComplete === true && (
                                        <>
                                        <a href="https://calendly.com/webibee/consultation" target="_blank" rel="noopener noreferrer" className="text-yellow-200 underline">https://calendly.com/webibee/consultation</a>
                                      {/* <Image
                                        alt="UPI QR Code"
                                        src={message.img}
                                        width={200}
