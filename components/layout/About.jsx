            ...
            <div className="flex flex-col lg:flex-row items-end justify-between gap-8 md:gap-8 max-w-6xl mx-auto">
                ...
                <div className="w-full lg:w-3/5 space-y-5 pb-3.5 font-sourceCodePro">
                    <p className="text-[clamp(1rem,1.15vw,1.3rem)] leading-6 font-secondary">
                        At Aspire Tech Academy, we go beyond just teaching we ensure our
                        learners are matched with roles and companies that align with their
                        unique strengths Our dedicated career support team works closely
                        with each student, helping them land roles in sectors where they can
                        thrive and grow. This thoughtful alignment gives our graduates the
                        ideal launchpad to kickstart a successful career.
                    </p>
                    <p className="text-[clamp(1rem,1.15vw,1.3rem)] leading-6 font-secondary">
                        At Aspire Tech Academy, we go beyond just teaching we ensure our
                        learners are matched with roles and companies that align with their
                        unique strengths Our dedicated career support team works closely wit
                    </p>
                </div>
            </div>
        </section>
